...
CREATE TABLE Transito(
    ...
    NumeroMuertesMoto INT NOT NULL,
...
CREATE TABLE AbastecimientoVolSalida(
    ...
    Fecha DATETIME NOT NULL,
    VolAtlantico INT NOT NULL,
    VolGuajira INT NOT NULL,
    VolBolivar INT NOT NULL,
    VolCesar INT NOT NULL,
    VolMagdalena INT NOT NULL,
    VolSantander INT NOT NULL,
    VolMagdalenaMedio INT NOT NULL,
    VolNorAntioquia INT NOT NULL,
    VolGuanenta INT NOT NULL,
